...
頼まれた瞬間に「WebサイトのpublishとGitHubは直接関係ないのでは」と思いました。GitHubはあくまでコード管理で、公開するにはGitHub Pagesとか別のサービスの話が出てくる。でも友人が本当にやりたいのはWebサイトを世に出すことで、その手段の一つとしてGitHub Pagesを使いたいというだけで、Git・GitHubを正確に理解することが目的ではない。

どこからどこまで話せばいいのか、まだ決めかねています。

「これを教えたいわけじゃない」と「でも正確に伝えたい」の間で毎回うろうろしていて、うまい落としどころを見つけられないまま今に至っています。なんとかしたい、とは思っているんですが。
