...
export const SystemGuideLink = () => {
    return (
        <div className="absolute bottom-20 left-10 hidden lg:block pointer-events-auto">
            <a href="/system" className="font-mono text-2xs text-muted-foreground hover:text-accent tracking-[0.2em] transition-colors border-b border-transparent hover:border-accent pb-1 flex items-center gap-2 group">
