...
const HistoryContent: React.FC = () => {
    const history = [
        ...
        {
            period: "2023 — 2025",
            role: "プロダクト開発・事業企画 (起業準備)",
            body: "共同創業候補と約2年、プロダクト開発と事業企画の実務に従事。方向性の違いから離脱。「ミーティングで芯食ったことを言う能力」はこの期間で鍛えられた。",
            active: false,
        },
        {
            period: "2023",
    ...
    return (
        <div className="space-y-6 text-base text-foreground/90 leading-relaxed">
            <p>
                ...
                プロダクトの判断軸として、技術的な美しさよりも事業から逆算する感覚を優先します ──
                AIChatClip は MVP 段階で <strong className="text-foreground">1,000 円の課金意思を確認してから</strong>
                本実装に着手しましたし、PL ダッシュボードも先輩の業務を見て自発的に提案・実装した、というのは性格として一貫しています。
            </p>
            <p>
                思考の癖として、
                <strong className="text-foreground">
                ...
                という型を自分のなかに持っています。囲碁 → 統計 → イラストの構図 → プロダクト設計 と、領域は違っても同じ姿勢で取り組んでいるのが面白いところで、エンジニアリング寄りの仕事はこの型と相性が良いと感じています。
            </p>
            <p>
                共同創業候補と過ごした起業準備の約 2 年では、
                <strong className="text-foreground">「ミーティングで芯食ったことを言う能力」</strong>
                を鍛えてもらいました。手を動かす力と同じくらい、
                早い段階で論点を絞り込み、判断を1つに集約することがプロダクト開発では重要だと考えています。
            </p>
            <p>
                技術の深さを盛って語ろうとはしません。代わりに、
                <strong className="text-foreground">
                    判断力と実行力 ──「何を作るか」「どう作るか」「いつ出すか」を一気通貫で詰める力
                </strong>
                で勝負したい、というのが立ち位置です。
            </p>
        </div>
