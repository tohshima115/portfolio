        ...
        <div className="space-y-10 text-base text-foreground/90 leading-relaxed">
            ...
            <section>
                ...
                <p className="mt-3">
                    ...
                    であることが性に合っています。SSR / SSG / CSR の境界が Vercel ではぼやけていたものが、Cloudflare に載せた瞬間に明確になり、それが自分の理解を一段引き上げる訓練になりました。
                </p>
    ...
    return (
        <div className="space-y-6 text-base text-foreground/90 leading-relaxed">
            ...
            <p className="pt-3 border-t border-border">
                キャリアを振り返って共通する軸は、
                <strong className="text-foreground">
                    「自分のスキルが世界でどこまで通用するかを試す」
                </strong>
                こと。受験そのものが楽しかった性格のままで、経営も起業準備もデザインも個人開発も、その時々で「ある程度通用するか」を試してきた感覚があります。次の場所も、その延長として選ぼうとしています。
            </p>
