...
const HistoryContent: React.FC = () => {
    const history = [
        ...
        },
        {
            ...
            body: "3人チームのプロジェクトに当初デザイナーとして参画。途中で「自分の設計を自分で実装する方が速い」と判断し、ロゴ・UI から実装まで担当範囲を拡張。Cursor 等の AI コーディングツール勃興期に重なり、Vercel + Next.js から試行を経て、最終的に React Router v7 + Astro + Hono の構成に落ち着いた。",
            active: false,
        },
        {
            period: "2023",
