...
デフォルトは24色。色数を減らしすぎるとパズルの継ぎ目線や浮いているピースなど細かい要素まで潰れて消えるので注意（6色だと消えた）。24色前後がノイズ除去と細部保持のバランスが良いことが多いが、絵柄によっては24色でもノイズ（斑点状のテクスチャ）が残ることがある（バリケードゲートの縞模様など、色の階調が多い絵柄で発生しやすい）。その場合は8〜12色まで下げて試す。必ず仕上がりを目視確認し、ノイズが残っていれば色数を減らす、細部が潰れていれば色数を増やす、で調整する。
